...
},{"./mobile-menu":"gWx5g","./slider":"aMYz0","./scroll":"55W1t"}],"gWx5g":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
(0, _jqueryDefault.default)(document).ready(function() {
    (0, _jqueryDefault.default)(".c-header__burger").click(function() {
        (0, _jqueryDefault.default)(".c-header__burger,.c-header__menu").toggleClass("active");
        (0, _jqueryDefault.default)("body").toggleClass("lock");
    });
});
...
(0, _jqueryDefault.default)(".c-featured__slider").slick({
    arrows: false,
    dots: true,
    adaptiveHeight: true,
    slidesToShow: 4,
...
},{"jquery":"hgMhh","slick-carousel":"ghMFH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ghMFH":[function(require,module,exports) {
(function(factory) {
    "use strict";
    if (typeof define === "function" && define.amd) define([
        "jquery"
    ], factory);
    else module.exports = factory(require("jquery"));
})(function($) {
    "use strict";
...
},{"jquery":"hgMhh"}],"55W1t":[function(require,module,exports) {
let mybutton = document.getElementById("scroll-top");
window.onscroll = function() {
    scrollFunction();
};
function scrollFunction() {
    if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) mybutton.style.display = "flex";
    else mybutton.style.display = "none";
}

},{}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire1ed2")
